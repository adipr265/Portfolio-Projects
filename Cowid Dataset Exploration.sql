...
-- Cowid Deaths Data
SELECT *
FROM PORTFOLIO1.COWIDDEATHS
ORDER BY 4,5
;

-- Cowid Vacinnations Data
SELECT *
FROM PORTFOLIO1.COWIDVACCINATIONS
ORDER BY 4,5
;

-- We are predominantly going to be using the Cowiddeaths Dataset to analyze the damage caused by the covid-19 virus on the world's population
...
-- Task 3: Looking at total cases vs populations to calculate the percentage of people infected with cowid-19 at any given time
...
FROM PORTFOLIO1.COWIDDEATHS DEA
JOIN PORTFOLIO1.COWIDVACCINATIONS VAC
